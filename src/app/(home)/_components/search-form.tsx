...
<form
  ...
  className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-md:grid-cols-1 max-md:relative max-md:mb-20"
>
  ...
  <div className="flex flex-col w-full">
    ...
    <div className="flex items-center gap-3">
      ...
      <select
        ...
        className="w-full sm:w-[150px] h-[50px] border-gray-300 rounded-lg"
        name="startTime"
  ...
  <div className="flex flex-col w-full">
    ...
    <div className="flex items-center gap-3">
      <DatePicker
        ...
        calendarProps={{
          minDate: new Date(
            (form.watch("startDate") ?? new Date()).getTime() + 3 * 24 * 60 * 60 * 1000
          ),
          maxDate: new Date(
            (form.watch("startDate") ?? new Date()).getTime() + 61 * 24 * 60 * 60 * 1000
          ),
        }}
  ...
  <div className="flex justify-center w-full col-span-2 mt-4">
